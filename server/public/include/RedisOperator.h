...
class RedisOperator : public Singleton<RedisOperator>,
                      public std::enable_shared_from_this<RedisOperator> {
  friend class Singleton<RedisOperator>;
...
public:
  ...
  void Close();
  bool SetExpire(const std::string &key, int seconds, const std::string &value);
